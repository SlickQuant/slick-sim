...
[`src/exchange/exch_cme.hpp`](https://github.com/SlickTech/exchange_simulator/blob/main/src/exchange/exch_cme.hpp)
...
[`types.hpp`](https://github.com/SlickTech/exchange_simulator/blob/main/src/common/types.hpp) and
...
[`main.cpp`](https://github.com/SlickTech/exchange_simulator/blob/main/src/sim/main.cpp#L199-L218)
...
[`Exchange::processRequest()`](https://github.com/SlickTech/exchange_simulator/blob/main/src/exchange/exchange.cpp#L68-L93)
...
[`Exchange::processRequest()`](https://github.com/SlickTech/exchange_simulator/blob/main/src/exchange/exchange.cpp#L74-L91)
...
[`CoinbasePublisher::publish_market_data_update`](https://github.com/SlickTech/exchange_simulator/blob/main/src/market_data_publisher/coinbase_publisher.cpp#L184-L201)
...
[`Exchange::publishMDTrades`](https://github.com/SlickTech/exchange_simulator/blob/main/src/exchange/exchange.cpp#L338-L349)
...
[empty function bodies with "stub implementation for testing" comments](https://github.com/SlickTech/exchange_simulator/blob/main/src/order_book/order_book.hpp#L470-L484).
...
[`pro_rata_matching_engine.hpp`](https://github.com/SlickTech/exchange_simulator/blob/main/src/matching_engine/pro_rata_matching_engine.hpp)
is a **zero-byte file**.
...
[`alpaca_historical_data_feed.hpp`](https://github.com/SlickTech/exchange_simulator/blob/main/src/md_feed/alpaca_historical_data_feed.hpp)
is a **zero-byte file**, and `md_feed`'s
[`CMakeLists.txt`](https://github.com/SlickTech/exchange_simulator/blob/main/src/md_feed/CMakeLists.txt)
...
[`exch_coinbase_feed_callbacks.cpp:220`](https://github.com/SlickTech/exchange_simulator/blob/main/src/exchange/exch_coinbase_feed_callbacks.cpp#L220-L245)
contains:
...
Both
[`OrderBook::executeOrder`](https://github.com/SlickTech/exchange_simulator/blob/main/src/order_book/order_book.hpp#L187)
and the
[matching loop](https://github.com/SlickTech/exchange_simulator/blob/main/src/matching_engine/fifo_matching_engine.cpp#L189)
...
[`fifo_matching_engine.cpp:272-276`](https://github.com/SlickTech/exchange_simulator/blob/main/src/matching_engine/fifo_matching_engine.cpp#L272-L276)
...
([`main.cpp:126`](https://github.com/SlickTech/exchange_simulator/blob/main/src/sim/main.cpp#L126)).
...
[`tcp_order_gateway.cpp`](https://github.com/SlickTech/exchange_simulator/blob/main/src/order_gateway/tcp_order_gateway.cpp),
[`fix_parser.cpp`](https://github.com/SlickTech/exchange_simulator/blob/main/src/order_gateway/fix_parser.cpp),
[`sbe_parser.cpp`](https://github.com/SlickTech/exchange_simulator/blob/main/src/order_gateway/sbe_parser.cpp),
[`json_parser.cpp`](https://github.com/SlickTech/exchange_simulator/blob/main/src/order_gateway/json_parser.cpp)
...
[API reference](https://slicktech.github.io/exchange_simulator/api/). Read the headers directly, or
