...
TEST_F(MatchingEngineTIFTest, FOK_CompletelyFilled_Success) {
    ...
    auto* buy_order = createTestOrder(order_pool_, Side::BUY, kPrice100, kQty10, TimeInForce::FILL_OR_KILL);
...
TEST_F(MatchingEngineTIFTest, FOK_WithSMP_CancelNewest_Validation) {
    ...
    auto* buy_order = createTestOrder(order_pool_, Side::BUY, kPrice100, kQty10, TimeInForce::FILL_OR_KILL, 123);
...
TEST_F(MatchingEngineTIFTest, IOC_PartialFill_RemainderNotAdded) {
    ...
    auto* buy_order = createTestOrder(order_pool_, Side::BUY, kPrice100, kQty10, TimeInForce::IMMEDIATE_OR_CANCEL);
...
TEST_F(MatchingEngineTIFTest, DAY_RestingOnBook) {
    ...
    auto* buy_order = createTestOrder(order_pool_, Side::BUY, kPrice100, kQty10, TimeInForce::DAY);
...
TEST_F(MatchingEngineTIFTest, GTC_RestingOnBook) {
    ...
    auto* buy_order = createTestOrder(order_pool_, Side::BUY, kPrice100, kQty10, TimeInForce::GOOD_TILL_CANCEL);
...
TEST_F(MatchingEngineTIFTest, FOK_AcrossMultipleLevels_Success) {
    ...
    auto* buy_order = createTestOrder(order_pool_, Side::BUY, kPrice101, kQty10, TimeInForce::FILL_OR_KILL);
...
TEST_F(MatchingEngineTIFTest, FOK_AcrossMultipleLevels_Insufficient) {
    ...
    auto* sell2 = createTestOrder(order_pool_, Side::SELL, kPrice101, kQty3);
    order_book_->addOrder(sell2, 1001, 2);
