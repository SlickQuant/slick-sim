...
#ifndef _SBE_PARTYDETAILSDEFINITIONREQUESTACK519_H_
#define _SBE_PARTYDETAILSDEFINITIONREQUESTACK519_H_
...
#pragma clang diagnostic pop
    ...
    std::string getMemoAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getMemoAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 12;
        size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    std::string getAvgPxGroupIDAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getAvgPxGroupIDAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 87;
        size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    #pragma clang diagnostic pop
        ...
        std::string getPartyDetailIDAsString() const
        {
        ...
        #if __cplusplus >= 201703L
        std::string_view getPartyDetailIDAsStringView() const SBE_NOEXCEPT
        {
            const char *buffer = m_buffer + m_offset + 0;
            size_t length = 0;
