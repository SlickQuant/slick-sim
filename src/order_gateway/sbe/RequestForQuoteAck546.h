...
#ifndef _SBE_REQUESTFORQUOTEACK546_H_
#define _SBE_REQUESTFORQUOTEACK546_H_
...
#pragma clang diagnostic pop
    ...
    std::string getExchangeQuoteReqIDAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getExchangeQuoteReqIDAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 288;
        size_t length = 0;
