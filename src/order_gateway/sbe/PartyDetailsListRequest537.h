...
#ifndef _SBE_PARTYDETAILSLISTREQUEST537_H_
#define _SBE_PARTYDETAILSLISTREQUEST537_H_
...
#pragma clang diagnostic pop
    ...
    #pragma clang diagnostic pop
        ...
        std::string getRequestingPartyIDAsString() const
        {
        ...
        #if __cplusplus >= 201703L
        std::string_view getRequestingPartyIDAsStringView() const SBE_NOEXCEPT
        {
            const char *buffer = m_buffer + m_offset + 0;
            size_t length = 0;
