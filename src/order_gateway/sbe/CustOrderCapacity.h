...
#ifndef _SBE_CUSTORDERCAPACITY_H_
#define _SBE_CUSTORDERCAPACITY_H_
...
public:
    enum Value
    {
        ...
        Memberfirmtradingforitsproprietaryaccount = (std::uint8_t)2,
        Membertradingforanothermemberornonmember = (std::uint8_t)3,
