...
#ifndef _SBE_EXECUTIONREPORTPENDINGCANCEL564_H_
#define _SBE_EXECUTIONREPORTPENDINGCANCEL564_H_
...
public:
    ...
    {
        return (std::uint16_t)219;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t sbeTemplateId() SBE_NOEXCEPT
    {
        return (std::uint16_t)564;
    }
...
#pragma clang diagnostic pop
    ...
    std::string getExecIDAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getExecIDAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 12;
        size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    std::string getSenderIDAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getSenderIDAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 52;
        size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    std::string getClOrdIDAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getClOrdIDAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 72;
        size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    std::uint64_t getLocation(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 140, sizeof(char) * static_cast<size_t>(length));
        return length;
    }
    ...
    std::string getLocationAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getLocationAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 140;
        size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    std::uint64_t getOrigOrderUser(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 203, sizeof(char) * static_cast<size_t>(length));
        return length;
    }
    ...
    std::string getOrigOrderUserAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getOrigOrderUserAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 203;
        size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    std::uint64_t getCancelText(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 211, sizeof(char) * static_cast<size_t>(length));
        return length;
    }
    ...
    std::string getCancelTextAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getCancelTextAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 211;
        size_t length = 0;
    ...
    friend std::basic_ostream<CharT, Traits>& operator<<(
        std::basic_ostream<CharT, Traits>& builder, ExecutionReportPendingCancel564 _writer)
    {
        ExecutionReportPendingCancel564 writer(_writer.m_buffer, _writer.m_offset,
