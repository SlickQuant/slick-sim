...
#ifndef _SBE_EXECUTIONREPORTTRADEADDENDUMOUTRIGHT548_H_
#define _SBE_EXECUTIONREPORTTRADEADDENDUMOUTRIGHT548_H_
...
public:
    ...
    #pragma clang diagnostic pop
        ...
        std::string getFillExecIDAsString() const
        {
            const char *buffer = m_buffer + m_offset + 12;
            size_t length = 0;
        ...
        #if __cplusplus >= 201703L
        std::string_view getFillExecIDAsStringView() const SBE_NOEXCEPT
        {
            const char *buffer = m_buffer + m_offset + 12;
            size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    #pragma GCC diagnostic pop
            ...
            m_bufferLength = bufferLength;
            GroupSize dimensions(buffer, *pos, bufferLength, actingVersion);
            dimensions.blockLength((std::uint16_t)45);
            dimensions.numInGroup((std::uint8_t)count);
            m_index = 0;
            m_count = count;
            m_blockLength = 45;
...
public:
    ...
    #pragma clang diagnostic pop
        ...
        std::string getOrderEventTextAsString() const
        {
        ...
        #if __cplusplus >= 201703L
        std::string_view getOrderEventTextAsStringView() const SBE_NOEXCEPT
        {
            const char *buffer = m_buffer + m_offset + 8;
            size_t length = 0;
