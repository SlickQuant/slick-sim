...
#ifndef _SBE_ESTABLISH503_H_
#define _SBE_ESTABLISH503_H_
...
#pragma clang diagnostic pop
    ...
    std::string getHMACSignatureAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getHMACSignatureAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 0;
        size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    std::string getAccessKeyIDAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getAccessKeyIDAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 32;
        size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    std::string getTradingSystemNameAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getTradingSystemNameAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 52;
        size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    std::string getTradingSystemVersionAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getTradingSystemVersionAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 82;
        size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    std::string getTradingSystemVendorAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getTradingSystemVendorAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 92;
        size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    std::string getSessionAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getSessionAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 122;
        size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    std::string getFirmAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getFirmAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 125;
        size_t length = 0;
...
#pragma clang diagnostic pop
    ...
    std::uint16_t credentialsLength() const
    {
        std::uint16_t length;
