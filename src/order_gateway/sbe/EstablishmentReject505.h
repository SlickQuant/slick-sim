...
#ifndef _SBE_ESTABLISHMENTREJECT505_H_
#define _SBE_ESTABLISHMENTREJECT505_H_
...
#pragma clang diagnostic pop
    ...
    std::string getReasonAsString() const
    {
    ...
    #if __cplusplus >= 201703L
    std::string_view getReasonAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 0;
        size_t length = 0;
