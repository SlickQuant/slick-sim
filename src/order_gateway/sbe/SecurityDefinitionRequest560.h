...
#ifndef _SBE_SECURITYDEFINITIONREQUEST560_H_
#define _SBE_SECURITYDEFINITIONREQUEST560_H_
...
#pragma clang diagnostic pop
    ...
    #if __cplusplus >= 201703L
    std::string_view getSecuritySubTypeAsStringView() const SBE_NOEXCEPT
    {
        const char *buffer = m_buffer + m_offset + 49;
        size_t length = 0;
