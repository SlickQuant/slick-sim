...
#ifndef _SBE_EXECUTIONREPORTSTATUS532_H_
#define _SBE_EXECUTIONREPORTSTATUS532_H_
...
#pragma clang diagnostic pop
    ...
    std::uint64_t getOrigOrderUser(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 497, sizeof(char) * static_cast<size_t>(length));
        return length;
    }
...
#pragma clang diagnostic pop
    ...
    std::uint64_t getCancelText(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 505, sizeof(char) * static_cast<size_t>(length));
        return length;
    }
