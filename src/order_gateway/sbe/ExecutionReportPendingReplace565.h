...
#ifndef _SBE_EXECUTIONREPORTPENDINGREPLACE565_H_
#define _SBE_EXECUTIONREPORTPENDINGREPLACE565_H_
...
public:
    ...
    {
        return (std::uint16_t)196;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t sbeTemplateId() SBE_NOEXCEPT
    {
        return (std::uint16_t)565;
    }
...
#pragma clang diagnostic pop
    ...
    friend std::basic_ostream<CharT, Traits>& operator<<(
        std::basic_ostream<CharT, Traits>& builder, ExecutionReportPendingReplace565 _writer)
    {
        ExecutionReportPendingReplace565 writer(_writer.m_buffer, _writer.m_offset,
