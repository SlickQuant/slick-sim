...
#ifndef _SBE_ORDERCANCELREQUEST516_H_
#define _SBE_ORDERCANCELREQUEST516_H_
...
#pragma clang diagnostic pop
    ...
    std::uint64_t getOrigOrderUser(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 88, sizeof(char) * static_cast<size_t>(length));
        return length;
    }
