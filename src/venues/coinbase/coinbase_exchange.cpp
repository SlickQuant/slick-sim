...
void CoinbaseExchange::poll()
{
    ...
    {
        // coinbase::UserThreadWebsocketCallbacks::processData - drains whatever the
        // SDK's network thread buffered into ws_mux_, firing our on* callbacks on
        // this (the exchange) thread.
        processData();
    }
